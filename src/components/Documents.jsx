...
const Documents = () => {
  ...
  // ✅ All files should be inside: /public/documents2/
  const tafDocuments = [
    { 
      title: "TAF Document - IT21291500",
      downloadUrl: `${process.env.PUBLIC_URL}/documents2/TAF - IT21291500.pdf`
    }
  ];
  ...
  const finalReportDocuments = [
    { 
      title: "Final Report - IT21291500",
      downloadUrl: `${process.env.PUBLIC_URL}/documents2/R25-082-Group Report.pdf`
    }
  ];
  ...
  return (
    <div>
      <section id="documents">
        <div className="container">
          ...
          <p className="section-subtitle">
            Access all the documentation related to the PulseMind project.
          </p>
      ...
      <style jsx>{`
        #documents {
          padding: 30px 0;
          background-image: url('${process.env.PUBLIC_URL}/img/dot2.png');
          background-size: cover;
        }
